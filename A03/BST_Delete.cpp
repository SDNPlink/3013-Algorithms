/*
This is a very simple implementation of a binary search on a 
dynamically allocated array of ints.

If you wanted some homework you could:
1. convert this entire file into some kind of binary search class.
2. do not used dynamic arrays, use vectors from the stl
...
// finally our binary search algorithm implementation.
...
int main() {
  ...
  int *a = new int[size]; // new dynamic in array of size
  ...
  // lots of repeated code blocks below, should be made into
  // a function!!! 
